...
\begin{frame}{Main Goal}
  \begin{figure}[ht]
    ...
    \begin{tikzpicture}
      ...
      % Flèche logo atome
      \draw<2>[-latex,my snake] ([yshift=.04\textwidth]petitordi.east) -- ([yshift=.04\textwidth]ordiquantique.west |- petitordi.west) node[midway,above] {\includegraphics[width=.15\textwidth]{figures/atome.png}};
