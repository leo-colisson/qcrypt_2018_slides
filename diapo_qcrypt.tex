...
%use a string of 0100 on the straight line to emphasize classical comm (on te 2 pictures)
%also if time I would say to add on Alice's side a small quantum device for the q comm - see Ur slides
...
%change title to "Applications of QFactory"
