...
\begin{standaloneframe}
  \begin{tikzpicture}[ampersand replacement=\&,row sep=3mm,nodes={inner sep=0pt},
    ...
    \draw<3-4,6-7,12>[-latex] ([yshift=-.04\textwidth]bob.west |- alice.west) -- ([yshift=-.04\textwidth]alice.east);
    % Flèche logo atome
    \draw<3-4>[-latex] ([yshift=.04\textwidth]alice.east) -- ([yshift=.04\textwidth]bob.west |- alice.west) node[midway,above=2mm] {\includegraphics[width=.12\textwidth]{qubit_a6.png}};
    \draw<6-7>[-latex] ([yshift=.04\textwidth]alice.east) -- ([yshift=.04\textwidth]bob.west |- alice.west) node[midway,above=2mm] {\includegraphics[width=.12\textwidth]{qubit_a3.png}};
